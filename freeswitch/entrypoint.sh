...
VARS='${EXTERNAL_IP} ${SIP_DOMAIN} ${FS_SIP_PORT} ${RTP_START} ${RTP_END} ${FS_ESL_PASSWORD} ${POSTGRES_USER} ${POSTGRES_PASSWORD} ${POSTGRES_DB} ${FS_DB_NAME} ${TRUNK_NAME} ${TRUNK_HOST} ${TRUNK_USER} ${TRUNK_PASS} ${TRUNK_REGISTER} ${TRUNK_DID}'
